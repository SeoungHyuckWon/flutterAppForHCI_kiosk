...
class DBHelperMenu {
  ...
  Future<void> insertMenuAll() async {
    ...
    // 만약 동일한 memo가 여러번 추가되면, 이전 데이터를 덮어쓸 것입니다.
    await db.rawQuery("""
        INSERT INTO menus(id,name,price,mainAllergy,subAllergy,rankScore)
        VALUES ('C1','에스프레소',2000,'카페인','커피추출액',0),
        ('C2','아메리카노',3000,'카페인','커피추출액, 물',0),
        ('C3','카페라떼',4000,'카페인','커피추출액, 우유',0),
        ('C4','카페모카',4000,'카페인','커피추출액, 초코시럽, 우유, 휘핑크림',0),
        ('C5','카푸치노',4000,'카페인','커피추출액, 우유',0),
        ('C6','카라멜마끼야또',4000,'카페인','커피추출액, 카라멜시럽, 우유',0),
        ('C7','바닐라라떼',4000,'카페인','커피추출액, 바닐라시럽, 우유',0),
        ('C8','비엔나커피',3000,'카페인','커피추출액, 물, 휘핑크림',0),
        ('C9','모카치노',4000,'카페인','커피추출액, 초코시럽, 우유',0),
        ('C10','헤이즐넛라떼',4000,'카페인, 헤이즐넛시럽','커피추출액, 우유',0),
        ('C11','에스프레소콘파냐',3000,'카페인','커피추출액, 휘핑크림',0),
        ('C12','플랫화이트',3000,'카페인','커피추출액, 우유',0),
